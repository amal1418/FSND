...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_404_sent_requesting_beyond_valid_question_page(self):
        res = self.client().get('/questions?page=1000', json={'question': 1})
        data = json.loads(res.data)
    ...
    def test_delete_question(self):
        ...
        self.assertEqual(res.status_code, 200)
        self.assertEqual(data['deleted'], 56)
    ...
    def test_422_if_category_dose_not_exist(self):
    ...
    def test_get_quiz(self):
        res = self.client().post('/quizzes', json={"previous_questions": [9, 23], "quiz_category" : {'type': 'History', 'id': 5}})
        data = json.loads(res.data)
